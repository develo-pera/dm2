  ...
  return (
    <div id="projekti">
      <div className="max-w-7xl mx-auto p-5 py-20">
        <h2 className="text-4xl font-bold mb-7">Planirane nekretnine i projekti</h2>
        ...
        <div className="mt-10">
          ...
          <p>Prijavite se na naš newsletter i saznajte čim projekat postane dostupan za investiranje. Ili se prijavite na listu čekanja za tokene i ostvarite prihod u svakom slučaju.</p>
