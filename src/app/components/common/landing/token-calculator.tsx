  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
      <div className="md:col-span-2 bg-zinc-100/50 p-5 rounded-xs">
        <p className="text-xl font-bold">Izračunajte potencijalnu zaradu od DM2 tokena po pojedinačnom projektu.</p>
        <p className="text-sm mb-5">Za potrebe ove kalkulacije pretpostavlja se da svaki projekat predstavlja objekat neto površine 10.000m<sup>2</sup>, kao i da su cena m<sup>2</sup> u izgradnji i prodajna cena iste za svaki projekat.</p>
        <div className="mb-5">
          <p className="mb-2">Vaš inicijalni ulog u tokene</p>
          <p className="mb-2 text-sm">Minimalni inicijalni ulog iznosi 150 €.</p>
      ...
      <div className="bg-[#242424] text-white p-5 rounded-xs">
        <p className="text-xl font-bold">Rezultat kalkulacije — DM2 tokeni</p>
        <p className="mb-5 text-sm">Investitori u DM2 tokene ostvaruju 20% od profita nakon prodaje svih realizovanih projekata, sve dok poseduju tokene.</p>
        <p>Vaš ulog</p>
