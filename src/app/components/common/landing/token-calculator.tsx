  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
      <div className="md:col-span-2 bg-zinc-100/50 p-5 rounded-xs">
        <p className="text-xl font-bold">Izracunajte svoju zaradu od tokena po pojedinacnom projektu.</p>
        <p className="text-sm mb-5">Za potrebe ove kalkulacije pretpostavljamo da je svaki projekat u pitanju objekat neto povrsine 10.000m<sup>2</sup> i da im je cena m<sup>2</sup> u izgradnji i prodaji ista.</p>
        <div className="mb-5">
          <p className="mb-2">Vas inicijalni ulog u tokene</p>
        ...
        <div className="mb-5">
          <p>Prosecna cena m<sup>2</sup> u izgradnji</p>
        ...
        <div>
          <p className="mb-2">Prosecna prodajna cena m<sup>2</sup></p>
      ...
      <div className="bg-[#242424] text-white p-5 rounded-xs">
        ...
        <p className="mb-5 text-sm">Investitori u dm2 tokene ostvaruju 20% od profita nakon prodaje svih realizovanih projekata dokle god imaju tokene u vlasnistvu.</p>
        <p>Vas ulog</p>
